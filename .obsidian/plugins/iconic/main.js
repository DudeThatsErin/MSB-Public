  ...
  "i18n/ar.json"(exports, module2) {
    module2.exports = {
      ...
      commands: {
        ...
        toggleAllFolderIcons: "\u062A\u0628\u062F\u064A\u0644 \u062C\u0645\u064A\u0639 \u0623\u064A\u0642\u0648\u0646\u0627\u062A \u0627\u0644\u0645\u062C\u0644\u062F",
        toggleMinimalFolderIcons: "\u062A\u0628\u062F\u064A\u0644 \u0623\u064A\u0642\u0648\u0646\u0627\u062A \u0627\u0644\u0645\u062C\u0644\u062F \u0627\u0644\u0628\u0633\u064A\u0637\u0629",
...
var require_en_GB = __commonJS({
  "i18n/en-GB.json"(exports, module2) {
    module2.exports = {
      menu: {
  ...
  "i18n/ja.json"(exports, module2) {
    module2.exports = {
      ...
      commands: {
        ...
        toggleAllFileIcons: "\u3059\u3079\u3066\u306E\u30D5\u30A1\u30A4\u30EB\u30A2\u30A4\u30B3\u30F3\u3092\u5207\u308A\u66FF\u3048\u308B",
        toggleAllFolderIcons: "\u3059\u3079\u3066\u306E\u30D5\u30A9\u30EB\u30C0\u30A2\u30A4\u30B3\u30F3\u3092\u5207\u308A\u66FF\u3048\u308B",
        toggleMinimalFolderIcons: "\u6700\u5C0F\u9650\u306E\u30D5\u30A9\u30EB\u30C0\u30A2\u30A4\u30B3\u30F3\u3092\u5207\u308A\u66FF\u3048\u308B",
  ...
  "i18n/ru.json"(exports, module2) {
    module2.exports = {
      ...
      commands: {
        ...
        toggleAllFolderIcons: "\u041F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0432\u0441\u0435 \u0437\u043D\u0430\u0447\u043A\u0438 \u043F\u0430\u043F\u043E\u043A",
        toggleMinimalFolderIcons: "\u041F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u043C\u0438\u043D\u0438\u043C\u0430\u043B\u044C\u043D\u044B\u0435 \u0437\u043D\u0430\u0447\u043A\u0438 \u043F\u0430\u043F\u043E\u043A",
...
var IconicSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(this.containerEl).setName(Strings.settings.showAllFolderIcons.name).setDesc(Strings.settings.showAllFolderIcons.desc).addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.showAllFolderIcons).onChange((value) => {
    ...
    new import_obsidian.Setting(this.containerEl).setName(Strings.settings.minimalFolderIcons.name).setDesc(Strings.settings.minimalFolderIcons.desc).addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.minimalFolderIcons).onChange((value) => {
    ...
    new import_obsidian.Setting(this.containerEl).setName(Strings.settings.uncolorDrag.name).setDesc(Strings.settings.uncolorDrag.desc).addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.uncolorDrag).onChange((value) => {
...
var REGEX_COLOR_MIX = /color-mix\(in srgb, rgba?\((\d+), (\d+), (\d+)(?:, ([\d.]+))?\)(?: (\d+)%)?, rgba?\((\d+), (\d+), ([\d.]+)(?:, ([\d.]+))?\)(?: ([\d.]+)%)?\)/;
var ColorUtils = class {
  ...
  static toRgb(color) {
    ...
    if (!color || COLORS.includes(color)) {
      switch (color) {
        ...
        case "red":
          ...
          break;
        case "orange":
          rawValue = "--color-orange";
          break;
        case "yellow":
          rawValue = "--color-yellow";
          break;
        case "green":
          rawValue = "--color-green";
          break;
        case "cyan":
          rawValue = "--color-cyan";
          break;
        case "blue":
          ...
          break;
        case "purple":
          rawValue = "--color-purple";
          break;
        case "pink":
          rawValue = "--color-pink";
          break;
        case "gray":
          rawValue = "--color-base-70";
          break;
      }
    ...
    return rgbValue.startsWith("color-mix") ? this.mixToRgb(rgbValue) : rgbValue;
  }
  /**
   * Convert color into RGB object.
   * @param color a color name, or a specific CSS color
   */
  static toRgbObject(color) {
    const [r, g, b] = this.toRgb(color).replaceAll(/[^\d.,]/g, "").split(",").map(Number);
    return { r, g, b };
  }
  /**
   ...
   */
  static toHslArray(color) {
    let [r, g, b] = this.toRgb(color).replaceAll(/[^\d.,]/g, "").split(",").map(Number);
...
ColorUtils.convertEl = document.createElement("div");
...
var IconManager = class {
  ...
  refreshIcon(item, iconEl, onClick) {
    ...
    if (item.icon) {
      if (ICONS.has(item.icon)) {
        ...
        if (item.color)
          IconManager.colorFilter(emojiEl, item.color);
      }
      iconEl.show();
   ...
   */
  static colorFilter(element, color) {
...
var IconPicker = class extends import_obsidian3.Modal {
  ...
  onOpen() {
    ...
    this.searchSetting = new import_obsidian3.Setting(this.contentEl).addExtraButton((colorResetButton) => {
      ...
      colorPicker.setValueRgb(ColorUtils.toRgbObject(this.color)).onChange((value) => {
    ...
    const buttonRowEl = import_obsidian3.Platform.isTablet ? buttonContainerEl.createDiv({ cls: "iconic-button-row" }) : null;
    if (this.icon !== null || this.color !== null) {
      ...
      } else if (import_obsidian3.Platform.isTablet && buttonRowEl) {
  ...
  openColorMenu(x, y) {
    ...
    for (const color of COLORS) {
      menu.addItem((menuItem) => {
        menuItem.setTitle(Strings.iconPicker.colors[color]).setChecked(color === this.color).setSection("color").onClick(() => {
          if (this.color === color) {
            this.color = null;
...
var FileIconManager = class extends IconManager {
  ...
  refreshChildIcons(files, itemEls) {
    for (const itemEl of itemEls) {
      ...
      if (file.items) {
        if (file.iconDefault)
          file.iconDefault = iconEl.hasClass("is-collapsed") ? "lucide-folder-closed" : "lucide-folder-open";
...
var BookmarkIconManager = class extends IconManager {
  ...
  refreshChildIcons(bmarks, itemEls) {
    for (const itemEl of itemEls) {
      ...
      let iconEl = selfEl.find(":scope > .tree-item-icon") ?? selfEl.createDiv({ cls: "tree-item-icon" });
      if (bmark.items) {
        if (bmark.iconDefault)
          bmark.iconDefault = iconEl.hasClass("is-collapsed") ? "lucide-folder-closed" : "lucide-folder-open";
        let folderIconEl = selfEl.find(":scope > .iconic-folder-icon:not(.tree-item-icon)");
        if (this.plugin.settings.minimalFolderIcons) {
          folderIconEl?.remove();
        } else {
  ...
  static async localize() {
    ...
    switch (window.localStorage.language) {
      ...
      case "de":
        ...
        break;
      case "en-GB":
        localizedStrings = await Promise.resolve().then(() => __toESM(require_en_GB()));
        break;
      case "es":
...
var IconicPlugin11 = class extends import_obsidian9.Plugin {
  ...
  async onload() {
    ...
    this.app.workspace.onLayoutReady(() => {
      (0, import_obsidian9.getIconIds)().map((id) => [id, id.replace(/^lucide-/, "").replace(/-/g, " ")]).map(([id, name]) => [id, name[0]?.toUpperCase() + name.slice(1)]).sort(([, aName], [, bName]) => aName.localeCompare(bName)).forEach(([id, name]) => ICONS.set(id, name));
  ...
  defineFileItem(tFile, fileId, unloading) {
    ...
    } else if (tFile instanceof import_obsidian9.TFolder && (fileIcon.color && !this.settings.minimalFolderIcons || this.settings.showAllFolderIcons)) {
