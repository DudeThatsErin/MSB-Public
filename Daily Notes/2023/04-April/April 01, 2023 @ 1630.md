...
<svg viewBox="0 0 3760 100">
  ...
  <g>
    <circle cx="910" cy="14" r="15" stroke="black" fill="white" />
  </g>
</svg>
So, I decided to completely switch over to Obsidian. We will see how I adjust to not having the handwriting anymore like Apple Notes and OneNote and UpNote. Someone put it in a good way though. They stated this:
![[Pasted image 20230401170332.png]]
They have a good point. Being able to link in other things and such is super nice.
I still have a few things #todo like..
- [x] Move over my Journals from Apple Notes. #todo ✅ 2023-05-04
- [ ] Link Obsidian to iPhone. #todo 
- [x] Set Obsidian to automatically update on git when I open my vault.
- [x] Do the same on iPhone & iPad (when opening and closing the vault) ✅ 2023-05-04
