...
caloriesEaten: 
mood: 
cssclasses: banner, banner-inline-title, banner-fade
excalidraw-plugin: parsed
excalidraw-open-md: true
taskbone-ocr:
---
![[Christmas_Tree-wallpaper-11000690banner.jpg|banner]]
> [!banner-icon] 🤢
# 📆 Journal for Tuesday the 06 of Aug 2024
...
<linearGradient id="Q4Gradient" x1="0%" y1="0%" x2="100%" y2="0%">
  ...
  <g>
    ...
    <circle filter="url(#dropShadow)" cx="2240" cy="150" r="30" stroke="white" fill="#FF00FF" stroke-width="5" />
    <rect x="1952" y="116" width="240" height="72" stroke-width="5" stroke="#FF00FF" fill="var(--background-primary)" rx="10" ry="10" />
    <text filter="url(#dropShadow)" x="2174" y="170" fill="white" font-size="60" text-anchor="end">6-Aug</text>
  </g>
</svg>
...
---
## 8:50 pm
I felt like crap today. Nauseous and everything. Just look at ![[2024 Health#Health Log Aug 6, 2024 at 10 05 PM]]
I tried to add more details to that but the extra 
