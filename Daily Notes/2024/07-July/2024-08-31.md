...
taskbone-ocr:
---
![[97-Attachments/images/banners/20181219_225306.png|banner]]
> [!banner-icon] 😄
...
<linearGradient id="Q4Gradient" x1="0%" y1="0%" x2="100%" y2="0%">
  ...
  <g>
    ...
    <circle filter="url(#dropShadow)" cx="2490" cy="150" r="30" stroke="white" fill="#FF00FF" stroke-width="5" />
    <rect x="2202" y="116" width="240" height="72" stroke-width="5" stroke="#FF00FF" fill="var(--background-primary)" rx="10" ry="10" />
    <text filter="url(#dropShadow)" x="2424" y="170" fill="white" font-size="60" text-anchor="end">31-Aug</text>
  </g>
</svg>
...
---
## 8:13 pm
I got this working on my iPad and iPhone! Woo! Daily Notes are working again. I just need to get my tasks section working in the sidebar and then I can migrate all of my tasks over and be done~ Reminders & Obsidian, that's it.
