...
taskbone-ocr:
---
![[download-6.jpg|banner]]
> [!banner-icon] ✾
# 📆 Journal for Wednesday the 07 of Aug 2024
...
<linearGradient id="Q4Gradient" x1="0%" y1="0%" x2="100%" y2="0%">
  ...
  <g>
    ...
    <circle filter="url(#dropShadow)" cx="2250" cy="150" r="30" stroke="white" fill="#FF00FF" stroke-width="5" />
    <rect x="1962" y="116" width="240" height="72" stroke-width="5" stroke="#FF00FF" fill="var(--background-primary)" rx="10" ry="10" />
    <text filter="url(#dropShadow)" x="2184" y="170" fill="white" font-size="60" text-anchor="end">7-Aug</text>
  </g>
</svg>
...
I am moving my tasks over to Obsidian. I finally got the work website to load. Took forever.

# Tasks
## New Tasks
- [x] Test ⏫ 🛫 2024-08-07 📅 2024-08-07 ✅ 2024-08-11
## Today
```tasks
shortmode
due before tomorrow
