...
banner_icon: 😄
---
# 📆 Journal for Monday the 11 of Mar 2024
...
<linearGradient id="Q4Gradient" x1="0%" y1="0%" x2="100%" y2="0%">
  ...
  <g>
    ...
    <circle filter="url(#dropShadow)" cx="710" cy="150" r="30" stroke="white" fill="#FF00FF" stroke-width="5" />
    <rect x="422" y="116" width="240" height="72" stroke-width="5" stroke="#FF00FF" fill="var(--background-primary)" rx="10" ry="10" />
    <text filter="url(#dropShadow)" x="644" y="170" fill="white" font-size="60" text-anchor="end">11-Mar</text>
  </g>
</svg>
...
3:40pm: Today is good. First day of work is tomorrow. Everyone is super nice. I am so glad I got the job. You have no idea. So, I am organizing and setting up Obsidian again. Decided to use it.
I also wanted to export stuff I've saved from the bookmarks bot in the Obsidian Server but there isn't a way.
![[Pasted image 20240311154346.png]]
So, there's that. That's so annoying. Oh well. So I am going to copy and paste the info I want to save here. Not sure where I will add them but I am going to add them here.

This is my current dark mode look with `AnuPpuccin`. I attempted to use `Minimal` BUT I just didn't like the way it looked. Anu just works better with my brain. I just worry cause it hasn't been updated in ~6 months.
![[Pasted image 20240311155225.png]]
I haven't set up light mode but I plan to do that after I "work out". Time to go walk on the treadmill for an hour while watching [Dagnel](https://twitch.tv/dagnel). I gave him my prime for this month cause I'm not playing ACNH anymore. TTYL! :FarHeart:
Erin Skidds
3:53 PM CDT
# Other Notes
<< [[2024-03-10|yesterday's note]] | [[2024-03-12|tomorrow's note]] >>