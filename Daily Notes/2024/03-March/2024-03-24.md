...
tags:
  - journal
banner: "[[earthbanner.jpg]]"
banner_icon: 🙂
---
# 📆 Journal for Sunday the 24 of Mar 2024
...
<linearGradient id="Q4Gradient" x1="0%" y1="0%" x2="100%" y2="0%">
  ...
  <g>
    ...
    <circle filter="url(#dropShadow)" cx="840" cy="150" r="30" stroke="white" fill="#FF00FF" stroke-width="5" />
    <rect x="552" y="116" width="240" height="72" stroke-width="5" stroke="#FF00FF" fill="var(--background-primary)" rx="10" ry="10" />
    <text filter="url(#dropShadow)" x="774" y="170" fill="white" font-size="60" text-anchor="end">24-Mar</text>
  </g>
</svg>
...
7:37pm: I had a good weekend this weekend. We stayed home.  It was super nice. It is now 8:30 and I need to sleep soon so I will finish working on my blog and update you tomorrow AM before I start working. I need to make A LOT of progress this week on the app so that's going to be my focus this week. Good luck to me! TTYL!
# Tasks
> [!check-r]- Overdue
> ```tasks
> shortmode
...
> ```
# Other Notes
<< [[2024-03-23|yesterday's note]] | [[2024-03-25|tomorrow's note]] >>