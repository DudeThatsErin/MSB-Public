...
mood:
---
# 📆 Journal for Monday the 24 of Jun 2024
<< [[2024-06-23|yesterday's note]] | [[2024-06-25|tomorrow's note]] >>
...
<linearGradient id="Q4Gradient" x1="0%" y1="0%" x2="100%" y2="0%">
  ...
  <g>
    ...
    <circle filter="url(#dropShadow)" cx="1790" cy="150" r="30" stroke="white" fill="#FF00FF" stroke-width="5" />
    <rect x="1502" y="116" width="240" height="72" stroke-width="5" stroke="#FF00FF" fill="var(--background-primary)" rx="10" ry="10" />
    <text filter="url(#dropShadow)" x="1724" y="170" fill="white" font-size="60" text-anchor="end">24-Jun</text>
  </g>
</svg>
