...
tags: 
  - journal 
---
# 📆 Journal for Sunday the 25 of Feb 2024
  ...
  <linearGradient id="Q4Gradient" x1="0%" y1="0%" x2="100%" y2="0%">
    ...
    <g filter="url(#brightness)">
      ...
      <circle filter="url(#dropShadow)" cx="560" cy="150" r="30" stroke="white" fill="#FF00FF" stroke-width="5" />
      <rect x="282" y="116" width="230" height="72" fill="var(--background-primary)" rx="10" ry="10" />
      <text filter="url(#dropShadow)" x="500" y="170" fill="white" font-size="60" text-anchor="end">25-Feb</text>
    </g>
  </svg>
...
# Other Notes
<< [[2024-02-24|yesterday's note]] | [[2024-02-26|tomorrow's note]] >>