# Argo CD
**Argo CD** is a declarative, GitOps continuous delivery tool for **[Kubernetes](Coding%20Cheat%20Sheets/kubernetes/kubernetes.md). It allows application definitions, configurations, and environments should be declarative and version controlled. Application deployment and lifecycle management should be automated, auditable, and easy to understand.
...
1. Install Argo CD on a **[Kubernetes](Coding%20Cheat%20Sheets/kubernetes/kubernetes.md) Cluster, using [kubectl](Coding%20Cheat%20Sheets/kubernetes/kubectl.md)**.
...
2. Add **[Traefik](Coding%20Cheat%20Sheets/apps/traefik/traefik.md) IngressRoute. 
...
2. Add new repository in ArgoCD via **[kubectl](Coding%20Cheat%20Sheets/kubernetes/kubectl.md) or the GUI
