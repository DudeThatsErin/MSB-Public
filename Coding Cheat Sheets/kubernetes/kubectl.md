...
Kubectl is a command line tool for communicating with a [Kubernetes Cluster](Coding%20Cheat%20Sheets/kubernetes/kubernetes.md)'s control pane, using the Kubernetes API.
...
Install Kubectl with [chocolatey](Coding%20Cheat%20Sheets/tools/chocolatey.md):
...
Install Kubectl with [homebrew](Coding%20Cheat%20Sheets/tools/homebrew.md):
