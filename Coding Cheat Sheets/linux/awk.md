# AWK
AWK (awk) is a domain-specific language designed for text processing and typically used as a data extraction and reporting tool. Similar to the **[Sed](Coding%20Cheat%20Sheets/linux/sed.md)** and **[Grep](Coding%20Cheat%20Sheets/linux/grep.md)** commands, it is a filter, and is a standard feature of most Unix-like operating systems, like **[Linux](Coding%20Cheat%20Sheets/linux/linux.md)**.
