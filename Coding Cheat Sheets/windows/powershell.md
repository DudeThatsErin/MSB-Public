...
2. Set up PowerShell Profile in [Windows Terminal](Coding%20Cheat%20Sheets/windows/windows-terminal.md).
```json
...
You can customize the look and feel of PowerShell with the Starship Prompt ([[Coding Cheat Sheets/tools/starship]]).
